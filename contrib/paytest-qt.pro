...
RESOURCES += src/qt/paytest.qrc src/qt/paytest_locale.qrc

TRANSLATIONS += src/qt/locale/paytest_bg.ts \
                src/qt/locale/paytest_de.ts \
                src/qt/locale/paytest_en.ts \
                src/qt/locale/paytest_es.ts \
                src/qt/locale/paytest_fi.ts \
                src/qt/locale/paytest_fr.ts \
                src/qt/locale/paytest_it.ts \
                src/qt/locale/paytest_ja.ts \
                src/qt/locale/paytest_pl.ts \
                src/qt/locale/paytest_pt.ts \
                src/qt/locale/paytest_ru.ts \
                src/qt/locale/paytest_sk.ts \
                src/qt/locale/paytest_sv.ts \
                src/qt/locale/paytest_vi.ts \
                src/qt/locale/paytest_zh_CN.ts \
                src/qt/locale/paytest_zh_TW.ts
