...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "PayTest - Implemented New PHI Algo PoW/PoS Hybird - Parallel Masternode - ThankYou - 216k155"; // Input Activation code to activate blockchain
