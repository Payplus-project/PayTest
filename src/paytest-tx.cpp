...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PayTest Core paytest-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  paytest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paytest transaction") + "\n" +
                               "  paytest-tx [options] -create [commands]   " + _("Create hex-encoded paytest transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paytest transaction
