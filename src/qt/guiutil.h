...
/** Utility functions used by the PAYTEST Qt UI.
 */
namespace GUIUtil
{
...
// Render PAYTEST addresses in monospace font
...
// Parse "paytest:" URI into recipient object, return true on successful parsing
