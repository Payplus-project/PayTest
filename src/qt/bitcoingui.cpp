                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PAYTEST Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PAYTEST address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and paytest: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PAYTEST Core"), this);
    aboutAction->setStatusTip(tr("Show information about PAYTEST Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PAYTEST"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PAYTEST addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PAYTEST addresses"));
    ...
    openAction->setStatusTip(tr("Open a PAYTEST: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PAYTEST Core help message to get a list with possible PAYTEST command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PAYTEST Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PAYTEST network", "", count));
}
...
{
    QString strTitle = tr("PAYTEST Core"); // default title
