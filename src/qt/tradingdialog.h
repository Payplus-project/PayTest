...
#ifndef PAYTEST_TRADINGDIALOG_H
#define PAYTEST_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfPAYTESTOnTradingTab();
    ...
    void showBalanceOfPAYTESTOnSendTab();
    void showBalanceOfPAYTESTOnBalanceTab();
    ...
    QString BuyPAYTEST(QString OrderType, double Quantity, double Rate);
    QString SellPAYTEST(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"PAYTEST/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"PAYTEST/BTC\"}"));// "{\"gender\":\"male\"}");
