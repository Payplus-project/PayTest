...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "PAYTEST server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PayTest features */
        {"paytest", "masternode", &masternode, true, true, false},
        //{"paytest", "masternodelist", &masternodelist, true, true, false},
        //{"paytest", "mnbudget", &mnbudget, true, true, false},
        //{"paytest", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"paytest", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"paytest", "mnsync", &mnsync, true, true, false},
        {"paytest", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"paytest", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use paytestd, or the -server option to paytest-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> paytest-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36363/\n";
}
