...
#if defined(NDEBUG)
#error "PAYTEST cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PayTest Signed Message:\n";
...
#       else
        if (!processed) ProcessPayTestsend(pfrom, strCommand, vRecv, processed);
