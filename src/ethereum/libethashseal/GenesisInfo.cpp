...
#include "genesis/paytestMainNetwork.cpp"
#include "genesis/paytestTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::paytestMainNetwork: return c_genesisInfoPayTestMainNetwork;
	case Network::paytestTestNetwork: return c_genesisInfoPayTestTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::paytestMainNetwork: return c_genesisStateRootPayTestMainNetwork;
	case Network::paytestTestNetwork: return c_genesisStateRootPayTestTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
