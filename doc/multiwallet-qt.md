...
In order to support loading of multiple wallets in paytest-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is paytest.cpp.
...
Changes to paytest.cpp
----------------------
paytest.cpp is the entry point into paytest-qt, and as such, will require some minor modifications to provide hooks for
