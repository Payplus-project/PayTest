...
This mechanism has been integrated into Bitcore-Node-PAYTEST which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PAYTEST-Project/insight-api-paytest#web-socket-api](https://github.com/PAYTEST-Project/insight-api-paytest#web-socket-api) 
* API: [https://github.com/PAYTEST-Project/insight-api-paytest#swifttx-transactions](https://github.com/PAYTEST-Project/insight-api-paytest#swifttx-transactions) 
...
By default, the PAYTEST Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PAYTEST Core daemon:
