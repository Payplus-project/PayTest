Contributing to PAYTEST Core
============================

The PAYTEST Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PAYTEST Core project, and is not to be
confused with overall PAYTEST Network Protocol consensus changes.

Whether a pull request is merged into PAYTEST Core rests with the project merge
...
Patches that change PAYTEST consensus rules are considerably more involved than
...
Where a patch set proposes to change the PAYTEST consensus, it must have been
...
The project leader is the release manager for each PAYTEST Core release.
